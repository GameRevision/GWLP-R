 ...
 *         &lt;element name="Nested" type="{}PacketNestedType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class PacketType {
    ...
    protected List<PacketNestedType> nested;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PacketNestedType }
     * 
     * 
     */
    public List<PacketNestedType> getNested() {
        if (nested == null) {
            nested = new ArrayList<PacketNestedType>();
        }
        return this.nested;
    }
