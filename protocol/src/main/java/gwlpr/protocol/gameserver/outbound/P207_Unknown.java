    ...
    extends GWMessage
{
    ...
    private P207_Unknown.NestedUnknown1 [] unknown1;
    ...
    public void setUnknown1(P207_Unknown.NestedUnknown1 [] unknown1) {
        this.unknown1 = unknown1;
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder("P207_Unknown[");
