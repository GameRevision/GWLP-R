 ...
 *
 * This can be used to setup a guild to be displayed in 
 * the alliance tab of the guild window. 
 *
 * @author GWLPR Template Updater
 */
public final class P278_GuildAllyGeneralAction extends GenericAction
{
    ...
    private byte capeDetailColor;
    private byte capeEmblemColor;
    private byte capeShape;
    private byte capeDetail;
    ...
    public void setCapeDetailColor(byte newValue)
    {
        capeDetailColor = newValue;
    }
    ...
    public void setCapeDetail(byte newValue)
    {
        capeDetail = newValue;
    }
    ...
    public void setData15(byte newValue)
    {
        data15 = newValue;
    }
    ...
    public boolean serialize()
    {
        ...
        try
        {
            ...
            buffer.put(capeDetailColor);
            buffer.put(capeEmblemColor);
            buffer.put(capeShape);
            buffer.put(capeDetail);
