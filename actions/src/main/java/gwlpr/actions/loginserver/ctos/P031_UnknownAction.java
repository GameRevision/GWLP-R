 ...
 */
public final class P031_UnknownAction extends GenericTriggerableAction
{
    ...
    private char[] unknown21;
    private char[] unknown22;
    ...
    public char[] getUnknown21()
    {
        return unknown21;
    }


    public char[] getUnknown22()
    {
        return unknown22;
    }
    ...
    public boolean deserialize()
    {
        ...
        try
        {
            ...
            unknown21 = new char[prefix_unknown21];
            
            for (int i = 0; i < prefix_unknown21; i++)
            {
                unknown21[i] = buffer.getChar();
            }
            short prefix_unknown22 = buffer.getShort();
            unknown22 = new char[prefix_unknown22];
            
            for (int i = 0; i < prefix_unknown22; i++)
            {
                unknown22[i] = buffer.getChar();
            }
        }
