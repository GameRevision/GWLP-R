...
public final class P021_UnknownAction extends GenericAction
{
    ...
    private List<Float> unknown5;
    private short unknown6;
    private List<Float> unknown7;
    ...
    private List<Float> unknown18;
    private List<Float> unknown19;
    private short unknown20;
    private int unknown21;
    private List<Float> unknown22;
    ...
    public void setUnknown5(List<Float> newValue)
    {
        unknown5 = newValue;
    }
    ...
    public void setUnknown7(List<Float> newValue)
    {
        unknown7 = newValue;
    }
    ...
    public void setUnknown18(List<Float> newValue)
    {
        unknown18 = newValue;
    }


    public void setUnknown19(List<Float> newValue)
    {
        unknown19 = newValue;
    }
    ...
    public void setUnknown22(List<Float> newValue)
    {
        unknown22 = newValue;
    }
    ...
    public boolean serialize()
    {
        ...
        try
        {
            ...
            buffer.put(unknown3);
            buffer.put(unknown4);
            buffer.putFloat(unknown5.get(0));
            buffer.putFloat(unknown5.get(1));
            buffer.putShort(unknown6);
            buffer.putFloat(unknown7.get(0));
            buffer.putFloat(unknown7.get(1));
            buffer.put(unknown8);
            ...
            buffer.putFloat(unknown18.get(0));
            buffer.putFloat(unknown18.get(1));
            buffer.putFloat(unknown19.get(0));
            buffer.putFloat(unknown19.get(1));
            buffer.putShort(unknown20);
            buffer.putInt(unknown21);
            buffer.putFloat(unknown22.get(0));
            buffer.putFloat(unknown22.get(1));
