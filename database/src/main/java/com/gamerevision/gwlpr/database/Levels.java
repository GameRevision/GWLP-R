...
@NamedQueries({
    ...
    @NamedQuery(name = "Levels.findByAttributePoints", query = "SELECT l FROM Levels l WHERE l.attributePoints = :attributePoints")})
public class Levels implements Serializable 
{
    ...
    public Levels(Integer level) {
        this.level = level;
    }

    public Levels(Integer level, int attributePoints) {
        this.level = level;
    ...
    public String toString() {
        return "com.gamerevision.gwlpr.database.Levels[ level=" + level + " ]";
    }
